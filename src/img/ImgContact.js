  ...
  return (
    <div>
      ...
      >
          ...
          <clipPath id="freepik--clip-path-2--inject-37">
            <path
              ...
              style={{
                fill: "#2e353a",
                clipPath:
                  "url(#freepik--clip-path--inject-1--inject-1--inject-37)",
              }}
            />
          </clipPath>
        </defs>
        ...
        <g id="freepik--speech-bubbles--inject-37">
          <rect
            x="200.41"
            y="115.25"
            width="130.69"
          ...
          />
          <polyline
            points="200.41 164 200.41 185.35 212.32 171.64"
            style={{ fill: "#F4A261" }}
          />
          <path
          ...
          <path
            ...
            style={{ fill: "#fff" }}
          />
          <circle cx="221.32" cy="128.38" r="8.48" style={{ fill: "#fff" }} />
          <rect
            x="200.41"
            y="195.3"
            width="130.69"
          ...
          />
          <polyline
            points="200.41 244.04 200.41 265.4 212.32 251.68"
            style={{ fill: "#F4A261" }}
          />
          <path
          ...
          <path
            ...
            style={{ fill: "#fff" }}
          />
          <circle cx="221.32" cy="208.42" r="8.48" style={{ fill: "#fff" }} />
        </g>
        <g id="freepik--Plant--inject-37">
          ...
          />
          <polygon
            points="152.72 405.81 110.38 405.81 98.47 336.47 164.63 336.47 152.72 405.81"
            style={{ fill: "#2e353a" }}
          />
        </g>
        <g id="freepik--Character--inject-37">
          <circle cx="227.3" cy="320.3" r="92.07" style={{ fill: "#F4A261" }} />
          <path
          ...
          />
          <path
            d="M379.08,405.13a18.19,18.19,0,0,0,10.36,7.51c7.25,2.07,9.33,1.55,10.88-.52"
            style={{ fill: "#fff" }}
          />
          <path
            ...
            style={{ fill: "#2e353a" }}
          />
          <path d="M366.13,400.47s8,5.73,11.91,5.84" style={{ fill: "#fff" }} />
          <path
          ...
          <path
            ...
            style={{ fill: "#F4A261", mixBlendMode: "multiply" }}
          />
          <path
          ...
          />
          <path
            d="M348.21,174.35l-13.72,9.24c2-.28,11.48-3.64,11.48-3.64"
            style={{ fill: "#fff" }}
          />
          <path
          ...
          />
          <path
            d="M246,216a14.57,14.57,0,0,0-6.17,1.17"
            style={{ fill: "#fff" }}
          />
          <path
          ...
          />
          <path
            d="M275.9,202.29s7.71-2.36,9.75-3.93"
            style={{ fill: "#fff" }}
          />
          <path
            ...
            style={{ fill: "#2e353a" }}
          />
          <path d="M287.54,197.58s1.26-1.1,1.73-1.1" style={{ fill: "#fff" }} />
          <path
          ...
          />
          <path
            d="M353.89,239.36c.55,0,7.48,3.82,7.48,3.82"
            style={{ fill: "#2e353a" }}
          />
          <path
          ...
          <g
            style={{
              clipPath:
                "url(#freepik--clip-path-2--inject-1--inject-1--inject-37)",
            }}
          >
            <path
              d="M303.29,155.23s-2.59,7.76-5.18,10.09a38.76,38.76,0,0,1-6.46,4.39s-1.55-5.43-5.43-5.43-9.83,2.59-9.83,2.59,0-2.07,4.91-4.66l4.92-2.58,11.38-4.4Z"
          ...
          />
          <path
            d="M277.34,145.12s-5.29-2.31-5.62,0,2,4,4.29,5a3.28,3.28,0,0,0,3.64-.33"
            style={{ fill: "#fff" }}
          />
          <path
          ...
          />
          <path
            d="M298.93,132.06s-5.89-1.4-3.37,6.45c.5,1.55,3.93,3.36,3.93,3.36s-.28,2.52-1.68,2.8"
            style={{ fill: "#fff" }}
          />
          <path
            ...
            style={{ fill: "#2e353a" }}
          />
          <path d="M294.72,150.27s-4.2.84-5.88-1.12" style={{ fill: "#fff" }} />
          <path
          ...
          />
          <path
            d="M288.56,137.11s-3.08-1.12-4.76.28a5.59,5.59,0,0,0-2,2.52"
            style={{ fill: "#fff" }}
          />
          <path
